...
(function() {
  ...
  /**
   * Page transition: show preloader then navigate
   */
  function navigateWithPreloader(href) {
  ...
  document.addEventListener('click', (e) => {
    ...
    /* Let glightbox handle direct image lightboxes, but navigate web pages */
    if (link.classList.contains('glightbox') && !href.includes('.html')) return;
  ...
  function removePreloader() {
    ...
    if (p) {
      ...
      if (elapsed < minDisplay) {
        setTimeout(() => p.remove(), minDisplay - elapsed);
      } else {
        p.remove();
      }
    }
